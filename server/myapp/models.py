...
class Comment(models.Model):
    ...
    thing = models.ForeignKey(Thing, on_delete=models.RESTRICT, blank=True, null=True)
...
class Record(models.Model):
    ...
    classification = models.ForeignKey(Classification, on_delete=models.RESTRICT, blank=True, null=True)
    thing = models.ForeignKey(Thing, on_delete=models.RESTRICT, blank=True, null=True)
    user = models.ForeignKey(User, on_delete=models.RESTRICT, blank=True, null=True)
...
class OpLog(models.Model):
    ...
    re_time = models.DateTimeField(null=True)
